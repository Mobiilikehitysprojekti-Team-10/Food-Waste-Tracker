...
const translations = {
    ...
    password: 'Salasana',
    employee: 'Työntekijä',
    change_office: 'Vaihda toimipistettä',
    select_office: 'Valitse toimipiste',
    edit: 'Muokkaa',
    ...
    select_office_before_login: 'Valitse toimipiste ennen kirjautumista',
    office_locked: 'Toimipiste on lukittu kirjautumisessa valitun toimipisteen mukaan.',
    enable_location: "Ota sijainti käyttöön",
    select_office_title: "Valitse toimipiste",
    select_office_hint: "Valitse toimipiste ensin (GPS:llä automaattisesti tai manuaalisesti).",
    no_nearby_office_pick_manual: "Lähistöltä ei löytynyt toimipistettä — valitse manuaalisesti",
    location_not_enabled_pick_manual: "Sijainti ei ole käytössä — valitse manuaalisesti",
  },
  en: {
    // Settings
    reports: 'Reports',
    ...
    select_office_before_login: 'Select office before login',
    office_locked: 'Office is locked based on your selection on the login screen.',
    enable_location: "Enable location",
    select_office_title: "Select office",
    select_office_hint: "Select an office first (auto by GPS or manually).",
    no_nearby_office_pick_manual: "No nearby office found — pick manually",
    location_not_enabled_pick_manual: "Location not enabled — pick manually",
  },
  sv: {
    // Inställningar
    reports: 'Rapporter',
    ...
    password: 'Lösenord',
    employee: 'Anställd',
    change_office: 'Byt enhet',
    select_office: 'Välj enhet',
    edit: 'Redigera',
    ...
    select_office_before_login: 'Välj driftställe innan inloggning',
    office_locked: 'Driftstället är låst baserat på ditt val på inloggningsskärmen.',
    enable_location: "Aktivera plats",
    select_office_title: "Välj enhet",
    select_office_hint: "Välj enhet först (automatiskt via GPS eller manuellt).",
    no_nearby_office_pick_manual: "Ingen enhet i närheten hittades — välj manuellt",
    location_not_enabled_pick_manual: "Plats är inte aktiverad — välj manuellt",
  },
};
